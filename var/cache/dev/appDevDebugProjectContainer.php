...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba' => 'get131c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2baService',
            '2_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba' => 'get231c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2baService',
        ...
        $this->privates = array(
            '1_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba' => true,
            '2_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba']) ? $this->services['1_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba'] : $this->get131c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2baService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba']) ? $this->services['2_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba'] : $this->get231c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2baService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d0eea19168c9cc64c382e4cdc89822b7dc1419b416e13b7291466e4ac61ef594');
    ...
    /**
     * Gets the '1_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get131c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2baService()
    {
        return $this->services['1_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get231c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2baService()
    {
        return $this->services['2_31c9e58748741b6a9473dcfab06183f744e997180cdc31fef74caef3868da2ba'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder.inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('PQntBshnlT', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L9OO6wDpkB', 0, 'nebiZM073QyPVNUdrzRZL+', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TjcjaJtG3n', 0, 'nebiZM073QyPVNUdrzRZL+', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9wm3ErQNE5', 0, 'nebiZM073QyPVNUdrzRZL+', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a9479d6364a01.12560188');
    }
